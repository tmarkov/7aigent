...
In the design document (`docs/design/help-system/`), address:
...
A complete design document (`docs/design/help-system/`) that:
...
- [x] Write complete design document in `docs/design/help-system/`
...
A comprehensive design document (`docs/design/help-system/`) that specifies exactly how the help system will work, what the agent will see at each step, and how it will be implemented. This design can then be handed off for implementation.
