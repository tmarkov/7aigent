...
Implement the help/documentation system designed in `docs/design/help-system/`. This system enables LLM agents to discover environment capabilities through self-documenting screen displays without requiring guesswork or external documentation.
...
- [ ] Read and understand `docs/design/help-system/` thoroughly
...
- [ ] Update documentation:
  ...
  - [ ] Update design/orchestrator/ if needed
  - [ ] Add usage examples to design doc
- [ ] Verify build passes: `nix build .#orchestrator`

# Dependencies

- **CRITICAL**: Requires `docs/design/help-system/` to be complete
