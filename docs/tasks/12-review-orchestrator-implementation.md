...
- **Related Documentation**:
  - `docs/design/orchestrator/` (design)
  - `docs/reference/coding-style.md` (standards)
...
- `docs/design/orchestrator/` - Core architecture and protocols
- `docs/capability-discovery.md` - Help system design
...
**Standards from `docs/reference/coding-style.md`:**
...
Verify compliance with `docs/reference/coding-style.md`:
...
**Environment Protocol (`docs/design/orchestrator/`):**
...
- [ ] Read `docs/design/orchestrator/` and compare to implementation
...
- [ ] Test examples from `docs/design/orchestrator/`
...
- Code meets quality standards from `docs/reference/coding-style.md`
