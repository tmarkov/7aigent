...
- **Related**: Agent design (`docs/design/agent/`), technology choices (`docs/development/development/technology.md`)
...
- [ ] **Step 8: Create Design Document**
  - [ ] Write `docs/design/sandbox/` with complete design
...
1. **Design document** (`docs/design/sandbox/`) that:
