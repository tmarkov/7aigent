...
For coding conventions and style guidelines, see [../reference/coding-style.md](../reference/coding-style.md).
...
**Contract**: See [../design/orchestrator/](../design/orchestrator/) for the complete Environment protocol specification
...
**Design**: See [../design/sandbox/](../design/sandbox/) for complete architecture and security model
...
See [../design/orchestrator/](../design/orchestrator/) for complete specifications of:
